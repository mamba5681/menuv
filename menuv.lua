...
function CreateMenuItem(info)
    ...
    local item = {
        ...
        Toggle = function(t, bool)
            t.Disabled = U:Ensure(bool, false)
        end,
        ---@param t Item
        ---@param event string Name of event
...
function CreateMenu(info)
    ...
    local item = {
        ...
        SetColor = function(t, colorR, colorG, colorB)
            t.Color.R = U:Ensure(colorR, 0)
            t.Color.G = U:Ensure(colorG, 0)
            t.Color.B = U:Ensure(colorB, 255)
        end,
